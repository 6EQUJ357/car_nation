                                        ...
                                        <div className="col-lg-4">
                                            <div className="ltn__tab-menu-list mb-50">
                                                <div className="nav">
                                                    ...
                                                    <a data-bs-toggle ="tab" href="#liton_tab_1_2">Vehicle Status <i className="fas fa-file-alt"></i></a>
                                                    <a data-bs-toggle ="tab" href="#liton_tab_1_3">Inspection Report <i className="fas fa-arrow-down"></i></a>
                                                    <a data-bs-toggle ="tab" href="#liton_tab_1_4">Previous Service Report <i className="fas fa-car-side"></i></a>
...
export default ReUseUserAccount