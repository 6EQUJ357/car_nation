    ...
    <div>
       ...
       [endif] */}
        ...
        <div className="body-wrapper"> 
            ...
            <div className="ltn__breadcrumb-area ltn__breadcrumb-area-2 ltn__breadcrumb-color-white bg-overlay-theme-black-90 bg-image" data-bs-bg="assets/img/service/brak_serv.webp">
                        ...
                        <div className="col-lg-12">
                            <div className="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                                <div className="section-title-area ltn__section-title-2">
                                    ...
                                    <h1 className="section-title white-color"> Brake Services</h1>
                                </div>
                                <div className="ltn__breadcrumb-list">
                                    <ul>
                                        <li><Link to="/">Home</Link></li>
                                        <li><Link to="/breakingservices">Service</Link></li>
                                        <li>Car Repair</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-8">
                            ...
                            <h2> Ensuring Safety and Performance on the Road</h2>
                                ...
                                <div className="ltn__blog-img">
                                    <img src="assets/img/service/brak_serv1.jpeg" alt="Image" />
                                </div>
                                ...
                                <div className="row">
                                    <div className="col-lg-6">
                                        <img src="assets/img/service/brak_serv.webp" alt="image" />
                                        {/* <label>Image caption here.</label> */}
                                    </div>
                                    <div className="col-lg-6">
                                        <img src="assets/img/service/brak_serv2.jpeg" alt="image" />
                                    </div>
                                </div>
...
export default ReUseBreakServices